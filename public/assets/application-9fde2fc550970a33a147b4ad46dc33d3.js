...
(function() {
  this.bakery = angular.module('bakery', ['ngMap', 'Devise']).config([
    '$routeProvider', function($routeProvider) {
      return $routeProvider.when('/desserts', {
...
(function() {
  this.bakery.controller('DessertIndexCtrl', [
    '$scope', '$location', '$http', function($scope, $location, $http) {
      $scope.desserts = [];
      $http.get('./desserts.json').success(function(data) {
        return $scope.desserts = data;
      });
      return $scope.viewDessert = function(id) {
        return $location.url("/desserts/" + id);
      };
    }
  ]);
...
(function() {
  this.bakery.controller('DessertShowCtrl', [
    '$scope', '$http', '$routeParams', function($scope, $http, $routeParams) {
      $http.get("./desserts/" + $routeParams.name + ".json").success(function(data) {
        $scope.dessert = data;
        return $scope.mainImageUrl = data.pictures[0].picture_url;
      });
...
(function() {
  this.bakery.controller('HomeCtrl', [
